...
sciences = glob.glob('/astro/sveash/cos_dark/corr_code/testing_M83-1/*_corrtag_a.fits')
rootdir = '/astro/sveash/cos_dark/corr_code'

for s in sciences:
    science = read_and_convert_science (s)  ## file with science exposure
    rootn = s.split('-1/')[1].split('_corr')[0]
    dark0 = read_dark ('/astro/sveash/cos_dark/corr_code/sp_FUVA_167_300days.npy') ## quiescent state dark
    dark1 = read_dark ('/astro/sveash/cos_dark/corr_code/superdark_ba_max.npy')    ## any number of peculiar superdarks
